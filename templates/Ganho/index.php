        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('data_ganho') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $ganho->hasValue('hospedagem') ? $this->Html->link($ganho->hospedagem->tipo_de_pagamento, ['controller' => 'Hospedagem', 'action' => 'view', $ganho->hospedagem->id]) : '' ?></td>
