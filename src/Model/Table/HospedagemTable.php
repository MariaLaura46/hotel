...
class HospedagemTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('tipo_de_pagamento');
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->dateTime('Data_hosped')
            ->requirePresence('Data_hosped', 'create')
            ->notEmptyDateTime('Data_hosped');
        ...
        $validator
            ...
            ->maxLength('tipo_de_pagamento', 20)
            ->requirePresence('tipo_de_pagamento', 'create')
            ->notEmptyString('tipo_de_pagamento');
